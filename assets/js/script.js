...
const translations = {
  pt: {
    ...
    project2_text: "Landing page desenvolvida para apresentar meu portfólio e fortalecer minha presença profissional como desenvolvedor front-end. O projeto foi construído utilizando HTML, CSS e JavaScript puro, com foco em design moderno, responsividade, animações suaves e uma navegação dinâmica para proporcionar uma melhor experiência ao usuário.",
  ...
  en: {
    ...
    project2_text: "A landing page developed to showcase my portfolio and strengthen my professional presence as a front-end developer. The project was built using pure HTML, CSS, and JavaScript, with a focus on modern design, responsiveness, smooth animations, and dynamic navigation to provide a better user experience.",
  ...
  es: {
    ...
    project2_text: "Una landing page desarrollada para presentar mi portafolio y fortalecer mi presencia profesional como desarrollador front-end. El proyecto fue construido utilizando HTML, CSS y JavaScript puro, con un enfoque en diseño moderno, responsividad, animaciones suaves y una navegación dinámica para proporcionar una mejor experiencia al usuario.",
